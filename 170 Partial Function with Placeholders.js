...
Placeholders "_" are replaced with values from the restArgs. Then the elements of the args are passed as separate arguments to fn, 
...
Placeholder "_" is replaced with 5 and 20 is added at the end of args. Then the elements of the args are passed as separate arguments to fn, 
    ...
    return function (...restArgs) {
        ...
        for (let i = 0; i < args.length; i++) {
            if (args[i] !== "_") {
                ...
                const item = restArgs.shift();
                newArr.push(item);
            }
        }
        const arr = newArr.concat(restArgs);
        return fn(...arr);
    };
};
